...
This folder contains **14 documentation files** that exhaustively explain the MiniVecDB codebase. Each file covers a specific aspect of the project.
...
| 10 | [10_file_cli.md](./10_file_cli.md) | `cli/main.py` | 743 | All 10 CLI commands, argparse setup, output formatting |
...
| 13 | [13_file_web_app.md](./13_file_web_app.md) | `web/app.py` + 7 templates | 510+405 | Flask web UI: 10 routes, session picker, search/insert/history/stats, JSON API |
...
| Testing | pytest + standalone | `tests/` (16 files) |
...
| `cli/main.py` | 743 | 24 KB | CLI interface |
| `web/app.py` | 510 | 17 KB | Flask web app |
| `web/templates/` (7 files) | ~790 | 23 KB | Jinja2 templates |
...
| Test files (16 files) | ~3700 | ~210 KB | Test suite + benchmarks |
